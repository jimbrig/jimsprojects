...
all_by_owner: jimbrig
# the repository where this repo exists
status_repo: jimbrig/jimsprojects
...
repos:
  ...
  - reserver
  - rezmod
  - self-insurance-kpi-app
  - actuarialapp
  - snippets
  - shinyshowcase
  - templateeR
  - property_allocation_demo
  rinterface:
  - shinydashboardPlus
---

[![Render Status](https://github.com/jimbrig/jimsprojects/actions/workflows/render.yml/badge.svg)](https://github.com/jimbrig/jimsprojects/actions/workflows/render.yml)
...
repos %>% 
  ...
  #   Subscribers = mean(Subscribers, na.rm = TRUE),
  #   Issues = mean(Issues, na.rm = TRUE),
  #   Forks = mean(Forks, na.rm = TRUE),
  #   Status = first(Status),
  #   Commit = knitr::combine_words(Commit)
  # ) %>%
  # ungroup() %>%
  arrange(desc(Stars)) %>%
